use super::{bindings, host_component, policies, poll, util, watch_event};
...
impl bindings::wasi::gpio::digital::HostDigitalInPin for host_component::HostComponent {
    ...
    ) -> Result<wasmtime::component::Resource<DigitalInPin>, bindings::wasi::gpio::general::GpioError>
    {
        ...
        implementations::check_invalid_flags(
            &flags,
            vec![
                bindings::wasi::gpio::digital::DigitalFlag::ACTIVE,
                bindings::wasi::gpio::digital::DigitalFlag::INACTIVE,
                bindings::wasi::gpio::digital::DigitalFlag::OUTPUT,
            ],
        )
        .map_err(|_| bindings::wasi::gpio::general::GpioError::InvalidFlag)?;

        let pin = self.get_pin(&pin_label)?;

        let config =
            DigitalConfigBuilder::new(pin_label, bindings::wasi::gpio::general::PinMode::In)
                .add_flags(flags)
                .build()
                .map_err(|_| bindings::wasi::gpio::general::GpioError::InvalidFlag)?;
    ...
    fn get_config(
        ...
        bindings::wasi::gpio::digital::DigitalConfig,
    ...
    > {
        ...
        let watch_event = match &pin.get_config().active_level {
            bindings::wasi::gpio::general::ActiveLevel::ActiveHigh => {
                watch_event::WatchType::Falling
            }
    ...
    > {
        ...
        let watch_event = match &pin.get_config().active_level {
            bindings::wasi::gpio::general::ActiveLevel::ActiveHigh => {
                watch_event::WatchType::Rising
            }
            bindings::wasi::gpio::general::ActiveLevel::ActiveLow => {
                watch_event::WatchType::Falling
            }
        };
...
impl bindings::wasi::gpio::digital::HostDigitalOutPin for host_component::HostComponent {
    fn get(
        ...
        wasmtime::component::Resource<DigitalOutPin>,
        bindings::wasi::gpio::general::GpioError,
    > {
        if !self
            .policies
        ...
        implementations::check_invalid_flags(
            &flags,
            vec![
                bindings::wasi::gpio::digital::DigitalFlag::INPUT,
                bindings::wasi::gpio::digital::DigitalFlag::PULL_UP,
                bindings::wasi::gpio::digital::DigitalFlag::PULL_DOWN,
            ],
        )
        .map_err(|_| bindings::wasi::gpio::general::GpioError::InvalidFlag)?;
        ...
        for flag in flags.iter() {
            if *flag == bindings::wasi::gpio::digital::DigitalFlag::ACTIVE {
        ...
        let config =
            DigitalConfigBuilder::new(pin_label, bindings::wasi::gpio::digital::PinMode::Out)
                .add_flags(flags)
                .build()
                .map_err(|_| bindings::wasi::gpio::general::GpioError::InvalidFlag)?;
...
impl bindings::wasi::gpio::digital::HostDigitalInOutPin for host_component::HostComponent {
    ...
    fn is_inactive(
        ...
        Ok(bindings::wasi::gpio::digital::PinState::Inactive == state)
    }
...
impl bindings::wasi::gpio::digital::HostStatefulDigitalOutPin for host_component::HostComponent {
    fn get(
        ...
        _flags: wasmtime::component::__internal::Vec<bindings::wasi::gpio::digital::DigitalFlag>,
    ) -> Result<
    ...
    fn get_config(
        &mut self,
        _self_: wasmtime::component::Resource<StatefulDigitalOutPin>,
    ) -> Result<
        bindings::wasi::gpio::digital::DigitalConfig,
        bindings::wasi::gpio::general::GpioError,
    > {
    ...
    fn set_state(
        &mut self,
        _self_: wasmtime::component::Resource<StatefulDigitalOutPin>,
        _state: bindings::wasi::gpio::digital::PinState,
    ) -> Result<(), bindings::wasi::gpio::general::GpioError> {
        Err(bindings::wasi::gpio::general::GpioError::ResourceInvalidated)
    }
