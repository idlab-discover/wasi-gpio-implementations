...
use super::{DigitalInOutPin, DigitalInPin, DigitalOutPin};

pub fn check_invalid_flags(
    flags: &Vec<bindings::wasi::gpio::digital::DigitalFlag>,
    disallowed_flags: Vec<bindings::wasi::gpio::digital::DigitalFlag>,
) -> Result<(), ()> {
    for flag in flags {
...
impl DigitalInOutPin {
    pub fn new(
        ...
        match pin_mode {
            bindings::wasi::gpio::general::PinMode::In => Self {
                pin: pin.into_io(rppal::gpio::Mode::Input),
                config,
            },
            bindings::wasi::gpio::general::PinMode::Out => Self {
